...
variable "do_distibution_fedora-36-x64" {
...
variable "do_distibution_fedora-38-x64" {
  description = "Fedora 38 x64"
...
variable "do_distibution_ubuntu-22-10-x64" {
  description = "Ubuntu 22.10 x64"
