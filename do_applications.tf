...
variable "do_application_amddeveloperclou-amdprimus" {
  description = "AMD Primus™ v26.7.0 on Ubuntu 24.04"
...
variable "do_application_amddeveloperclou-unslothstudioroc" {
  description = "Unsloth Studio (ROCm 7.2.4) 2026.9.11 on Ubuntu 24.04"
...
variable "do_application_amddeveloperclou-vllm0271vllmomni" {
  description = "vLLM 0.30.0 + vLLM-Omni (ROCm 7.14) 0.30.0 on Ubuntu 24.04"
...
variable "do_application_neuralmagic-deepsparseinfere" {
  description = "DeepSparse Inference Runtime 1.5.2 on Ubuntu 22.10"
  default     = "neuralmagic-deepsparseinfere"
}
...
variable "do_application_techdomeai-sparrowcommunityedition1" {
  description = "Sparrow-Community-Edition 1.4.5 on 24.04"
...
variable "do_application_tips4designsrl-uxwizz" {
  description = "UXWizz 7.1.0 on Ubuntu 20.04"
